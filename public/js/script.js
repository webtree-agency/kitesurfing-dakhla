(function ($) {
    ...
    // Wird nach der React-Hydration nachgeladen — DOMContentLoaded/load können
    // dann bereits gefeuert haben. Guards stellen sicher, dass die Handler
    // trotzdem genau ein Mal laufen (Verhalten identisch zur statischen Seite).
    const onDomReady = (fn) => {
