 ...
 *
 * Wird sowohl vom Frontend-Layout als auch von der Root-404 (src/app/not-found.tsx)
 * genutzt. Die Root-404 braucht ein eigenes Gerüst, weil beide Route-Groups
 * ((frontend) und (payload)) je ein eigenes Root-Layout haben und es damit kein
 * gemeinsames darüberliegendes Layout gibt.
 *
