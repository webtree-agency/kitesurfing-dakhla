...
// Inhalt der 404-Seite (404.html) — bewusst rein statisch (keine CMS-Loader),
// damit sie auch bei Datenbank-Problemen zuverlässig rendert.
// Genutzt von src/app/not-found.tsx (unbekannte URLs, statisch prerendert) und
// src/app/(frontend)/not-found.tsx (notFound() aus einer Frontend-Route).
    ...
    <>
      ...
      <section className="padding-small vh-100 d-flex align-items-center justify-content-center">
        <div className="container text-center">
          ...
          <h3 className="display-5 fw-bold" dangerouslySetInnerHTML={{ __html: content.heading }} />
